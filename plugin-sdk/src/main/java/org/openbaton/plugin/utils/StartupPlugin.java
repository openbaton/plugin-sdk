...
public class StartupPlugin {
  ...
  private static <T extends Remote> Remote getStub(Class<T> plugin)
      throws InstantiationException, IllegalAccessException,
          java.lang.reflect.InvocationTargetException, NoSuchMethodException, RemoteException {
    return plugin.getConstructor().newInstance();
  }

  public static <T extends Remote> void register(
      Class<T> clazz, String name, String registryIp, int port)
      throws InvocationTargetException, NoSuchMethodException, RemoteException,
  ...
  public static void unregister(String name, String registryIp, int port)
      throws RemoteException, NotBoundException, MalformedURLException {
    Naming.unbind("//" + registryIp + ":" + port + "/" + name);
  }

  public static void unregister(String name, String registryIp)
      throws RemoteException, NotBoundException, MalformedURLException {
